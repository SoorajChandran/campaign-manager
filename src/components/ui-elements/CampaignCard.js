...
class CampaignCard extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      sortOptions: [
        ...
        ["sales_conversion_value_cents", "Sales conversion"],
        ["lead_conversion_value_cents", "Leads conversion"],
        ["days", "Duration"]
      ],
      filterOptions: [
        ["null", "Select"],
  ...
  render() {
    ...
    const campaignDataGrid = this.state.data.map(data => {
      return (
        <div key={data.title} className="col-sm-6 mt-4">
          <div className="campaignCard">
            ...
            <div className="campaignMetric col-sm-12 row">
              <div className="col-sm-4 br1 pt-4 pb-4">
                <div className="metricTitle muted">Sales conversion</div>
                ...
                <div className="metricTitle muted">Leads conversion</div>
                <div className="metricValue large">
                  <span className="sign">$</span>
                  <span className="value">
                    {" "}
      ...
      <div className="row">
        <div className="col-sm-12 pt-2">
          <div className="row">
            ...
            <div className="col-sm-3">
              Filter by: <i className="fa fa-filter" aria-hidden="true" />
              <select
                id="filter"
                className="form-control"
        ...
        <div className="col-sm-12">
          <ul className="pageNumberWrapper">{renderPageNumbers}</ul>
        </div>
      </div>
    );
  }

  compare = propName => (a, b) =>
